...
use crate::{draw_board, DiceRollUI, SelectedRegion, StackRankDiceGameBoardElement};

pub(crate) struct RegionClashEventStart {
    region_1: Region,
    region_2: Region,
}

pub(crate) struct RegionClashEventEnd {
    region1: Region,
    region2: Region,
    dice_1_sum: usize,
    dice_2_sum: usize,
